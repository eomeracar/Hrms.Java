...
public class ISHKPSPublicSoap
{
    ...
    public ISHKPSPublicSoap(){}

    public ISHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ISHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ISHExtendedSoapSerializationEnvelope envelope= new ISHExtendedSoapSerializationEnvelope(ISHExtendedSoapSerializationEnvelope.VER11);
