...
public class ISHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ISHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ISHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ISHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ISHDateTimeConverter dateTimeConverter = new ISHStandardDateTimeConverter();

    public ISHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ISHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ISHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ISHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ISHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ISHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
